...
if __name__ == '__main__':
    ...
    # and query the reward a large number of times. We use this
    # iterative one sample-at-a-time approach because this is used later
    # for the different learning frameworks we will encounter.    
    bandit = Bandit(1, 2)
